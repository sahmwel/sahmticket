...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-black/90 backdrop-blur-2xl">
          ...
          <div className="relative">
            <img
              ...
              className="h-28 md:h-36 lg:h-44 w-auto object-contain 
                         drop-shadow-2xl transition-all duration-500 group-hover:scale-110"
            />
            <div className="absolute -inset-12 md:-inset-16 
                            ...
                            group-hover:opacity-100 transition-all duration-700 -z-10" />
          </div>
        </Link>
      ...
      <motion.div
        ...
        className="lg:hidden fixed inset-x-0 top-16 bg-black/95 backdrop-blur-3xl"
        style={{ height: 'calc(100dvh - 64px)', transform: 'translateY(-20px)' }}
      >
